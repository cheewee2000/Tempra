...
- (void)drawEntireGraph {
    ...
    if (self.enableYAxisLabel) {
        ...
        labelYaxisOffset = [longestLabel.text sizeWithAttributes:attributes].width + 10;
...
- (void)drawYAxis {
    ...
    if (self.autoScaleYAxis) {
        ...
        for (NSNumber *dotValue in dotValues) {
            ...
            UILabel *labelYAxis = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, labelYaxisOffset, 10)];
